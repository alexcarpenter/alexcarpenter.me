      ...
      <Grid cols={1} colsSm={2}>
        <Grid.Item>
          <Card>
            ...
            <Card.Title>CSS Architecture</Card.Title>
            <Card.Description>
              CSS will always be my first love. I've enjoyed "hand-crafting" CSS
              for each project over the years but lately I have come to prefer
              using TailwindCSS for scalable styling needs.
            </Card.Description>
          </Card>
        </Grid.Item>
        <Grid.Item>
          <Card>
            ...
            <Card.Description>
              React has allowed me to build out complex interactive UIs with
              ease. Paired with a strong active community, React has become my
              library of choice for building user interfaces.
            </Card.Description>
          </Card>
        </Grid.Item>
      </Grid>
