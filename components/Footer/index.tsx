  ...
  return (
    <div className='border-t mt-auto pt-8 max-w-screen-sm mx-auto w-full'>
      <ul className='flex space-x-3'>
        ...
        <li>
          <a className='hover:text-blue' rel='me' aria-label='Twitter' href='https://twitter.com/hybrid_alex'>
        ...
        <li>
          <a className='hover:text-blue' rel='me' aria-label='Github' href='https://github.com/alexcarpenter'>
            <svg focusable='false' aria-hidden='true' width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
              <path
                fill='currentColor'
        ...
        <li>
          <a className='hover:text-blue' rel='me' aria-label='Codepen' href='https://codepen.io/alexcarpenter'>
            <svg focusable='false' aria-hidden='true' viewBox='0 0 24 24' width='24' height='24' xmlns='http://www.w3.org/2000/svg'>
              <path
                fill='currentColor'
        ...
        <li>
          <a className='hover:text-blue' rel='me' aria-label='Dribbble' href='https://dribbble.com/alexcarpenter'>
            <svg focusable='false' aria-hidden='true' width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
              <path
                fill='currentColor'
        ...
        <li>
          <a className='hover:text-blue' rel='me' aria-label='Linkedin' href='https://www.linkedin.com/in/imalexcarpenter'>
            <svg focusable='false' aria-hidden='true' width='24' height='24' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'>
              <path
                fill='currentColor'
