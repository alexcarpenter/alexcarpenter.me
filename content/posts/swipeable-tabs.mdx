...
description: Learn how to build an swipeable tabbed interface using Reach Tabs and React Swipeable.
date: '2021-10-20'
tags: ['react', 'accessibility']
---

I just finished up a project at work that required an tabbed interface that was swipeable on touch devices. In this post I will walk you through how I used a combination of [Reach Tabs](https://reach.tech/tabs/) and [React Swipeable](https://github.com/FormidableLabs/react-swipeable) to build out this component.
