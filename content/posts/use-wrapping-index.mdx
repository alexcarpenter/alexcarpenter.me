...
View sample usage within my [Lightbox](https://github.com/alexcarpenter/alexcarpenter-next/blob/main/components/Lightbox.tsx) component on this site or view the code on [Github](https://github.com/alexcarpenter/use-wrapping-index).
